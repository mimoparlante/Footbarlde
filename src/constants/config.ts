export const CONFIG = {
  ...
  language: 'Italian', // This changes the display name for your language
  wordLength: 5, // This sets how long each word is based on how many characters (as defined in orthography.ts) are in each word
  author: 'MimoParlante', // Put your name here so people know who made this Wordle!
  ...
  availableLangs: ['en', 'it'], // the options available to the user for translation languages
}
